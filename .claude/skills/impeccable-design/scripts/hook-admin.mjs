...
const IMPECCABLE_HOOK_COMMAND_MARKERS = [
  'skills/impeccable-design/scripts/hook-probe.mjs',
  'skills/impeccable-design/scripts/hook.mjs',
  'skills/impeccable-design/scripts/hook-before-edit.mjs',
  'skills/impeccable-design/scripts/hook-after-edit.mjs',
  'skills/impeccable-design/scripts/hook-stop.mjs',
];
...
const HOOK_MANIFEST_TARGETS = [
  {
    ...
    manifest: () => ({
      ...
      hooks: {
        PostToolUse: [
          {
            ...
            hooks: [
              {
                type: 'command',
                command: 'node "${CLAUDE_PROJECT_DIR}/.claude/skills/impeccable-design/scripts/hook.mjs"',
        ...
        Stop: [stopManifestEntry('node "${CLAUDE_PROJECT_DIR}/.claude/skills/impeccable-design/scripts/hook.mjs"')],
      },
    }),
  },
  {
    ...
    manifest: () => ({
      hooks: {
        PostToolUse: [
          {
            ...
            hooks: [
              {
                type: 'command',
                command: 'node ".agents/skills/impeccable-design/scripts/hook.mjs"',
                timeout: TIMEOUT_SECONDS,
                statusMessage: STATUS_MESSAGE,
              },
            ],
        ...
        Stop: [stopManifestEntry('node ".agents/skills/impeccable-design/scripts/hook.mjs"')],
      },
    }),
  },
  {
    ...
    manifest: () => ({
      ...
      hooks: {
        preToolUse: [
          {
            command: 'node ".cursor/skills/impeccable-design/scripts/hook-before-edit.mjs"',
            timeout: TIMEOUT_SECONDS,
          },
        ],
      },
        ...
        postToolUse: [
          {
            ...
            bash: 'node "$(git rev-parse --show-toplevel)/.github/skills/impeccable-design/scripts/hook.mjs"',
