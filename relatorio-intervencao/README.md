...
- **Registo de gases fluorados** (art. 7.º do Reg. (UE) 2024/573 · DL n.º 145/2017): só aparece
  quando há manuseamento de gás. Calcula t CO2e (GWP AR4), se a verificação de fugas é
  obrigatória e com que periodicidade (art. 5.º: 5 / 50 / 500 t, com e sem deteção,
  herméticos < 10 t), a data limite da nova verificação após reparação (1 mês) e a próxima
  verificação periódica. Bloqueia registos ilegais: **R22 nunca pode ser carregado**, recarga
  sem verificação de fugas, recarga com fuga por reparar, recarga sem ensaio final, gás
  reciclado/regenerado sem instalação e certificado, técnico sem n.º de certificado.
...
- **Relatório congelado** ao emitir: hash SHA-256 do conteúdo impresso no rodapé ("Ref.");
  alterações só por **Retificar** (nova versão, número novo, assinaturas de novo).
...
- **Entrega**: email com resumo (mailto; o PDF anexa-se à mão), JSON por relatório ou em lote,
  partilha (Web Share) no telemóvel, importação no PC do escritório.
...
fuga reparada e recarga, assinaturas, PDF de 4 páginas, recarga da página, retificação.
...
- **Não substitui a ficha do caderno de registo do Organismo de Certificação** (DL 145/2017):
  ...
  pelo técnico. Formato do n.º de certificado, certificado da empresa e tratamento de HFO
  (Anexo II) estão marcados "a confirmar com o OC".
